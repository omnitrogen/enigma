...
Label(frame, image=image).pack(padx=10, pady=10, side=TOP)
...
helpButton = Button(frame, text ="Help! Quick Start", command = help)
...
#text_entry
entryvar = StringVar()
entry = Entry(frame, textvariable = entryvar, width=50)
entry.focus_set()
...
#button_to_(de)code
b1 = Button(frame, text="(de)code", width=10, command=code)
b1.pack()
...
#credits
credits = Label(frame, text = "coded with <3 by omnitrogen")
